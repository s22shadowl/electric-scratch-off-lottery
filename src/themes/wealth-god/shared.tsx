...
export const SYMBOL_MOBILE: SymbolLayoutConfig = {
  ...
  title: { caishen: 47, prize: 38, letterSpacing: "8px" },
  ...
  decorations: [
    ...
    { type: "✦", top: 325, right: 50, fontSize: 19, opacity: 1 },
    {
      type: "金磚",
      top: 383,
      left: 167,
  ...
  helpText: { fontSize: 13, bottom: 12, left: 14, letterSpacing: "1px" },
  prizeBadge: {
    fontSize: 29,
    top: 97,
    left: 0,
...
export const SYMBOL_DESKTOP: SymbolLayoutConfig = {
  ...
  title: { caishen: 69, prize: 57, letterSpacing: "10px" },
  titleShadow: "1px 1px 2px rgba(0,0,0,0.9)",
  ...
  decorations: [
    ...
    { type: "✦", top: 491, right: 76, fontSize: 23, opacity: 1 },
    {
      type: "金磚",
      top: 587,
      left: 270,
  ...
  helpText: { fontSize: 19, bottom: 18, left: 21, letterSpacing: "1.5px" },
  prizeBadge: {
    fontSize: 40,
    top: 150,
    left: 0,
