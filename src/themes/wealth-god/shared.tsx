  ...
  cells: [
    {
      ...
      rotation: "-6deg",
      clipPath:
        "polygon(2% 8%,15% 1%,35% 5%,55% 0%,78% 3%,95% 1%,100% 12%,98% 45%,100% 78%,97% 95%,85% 100%,60% 97%,35% 100%,12% 96%,0% 88%,3% 55%,0% 25%)",
    },
    {
      w: 132,
      h: 82,
      ...
      rotation: "5deg",
      clipPath:
        "polygon(4% 5%,20% 0%,42% 4%,68% 1%,88% 3%,100% 8%,97% 40%,100% 72%,96% 95%,82% 100%,55% 97%,28% 100%,8% 95%,0% 82%,2% 50%,0% 18%)",
    },
    {
      w: 135,
      h: 84,
      ...
      rotation: "7deg",
      clipPath:
        "polygon(3% 12%,18% 2%,40% 6%,62% 0%,85% 4%,100% 10%,98% 48%,100% 82%,95% 100%,72% 96%,48% 100%,22% 97%,5% 100%,0% 85%,2% 52%,0% 22%)",
    },
    {
      w: 138,
      h: 86,
      ...
      rotation: "-4.5deg",
      clipPath:
        "polygon(5% 6%,22% 1%,45% 5%,70% 0%,92% 4%,100% 15%,97% 50%,100% 85%,93% 100%,68% 96%,42% 100%,18% 97%,0% 90%,3% 58%,0% 22%)",
    },
  ],
  decorations: [
    {
