...
export const DIFFICULTY_PRESETS: Record<DifficultyPreset, PresetTemplate> = {
  generous: {
    ...
    prizes: [
      { label: "", amount: 0, weight: 40 },
      { label: "", amount: 100, weight: 45 },
      { label: "", amount: 500, weight: 15 },
    ],
  },
  standard: {
    label: "標準",
    ...
    description: "一般聚會用",
    prizes: [
      { label: "", amount: 0, weight: 45 },
      { label: "", amount: 100, weight: 45 },
      { label: "", amount: 500, weight: 10 },
    ],
  },
  conservative: {
    label: "保守",
    ...
    description: "競爭感更強",
    prizes: [
      { label: "", amount: 0, weight: 60 },
      { label: "", amount: 100, weight: 30 },
      { label: "", amount: 500, weight: 10 },
    ],
  },
  realistic: {
    ...
    prizes: [
      { label: "", amount: 0, weight: 68 },
      { label: "", amount: 100, weight: 19 },
      { label: "", amount: 200, weight: 7 },
      { label: "", amount: 500, weight: 3 },
      { label: "", amount: 2000, weight: 0.5 },
      { label: "", amount: 10000, weight: 0.05 },
      { label: "", amount: 300000, weight: 0.0001 },
    ],
  },
  party: {
    label: "派對",
    ...
    prizes: [
      { label: "", amount: 0, weight: 50 },
      { label: "", amount: 100, weight: 14 },
      { label: "", amount: 200, weight: 6 },
      { label: "", amount: 500, weight: 3 },
      { label: "", amount: 2000, weight: 0.6 },
      { label: "", amount: 10000, weight: 0.15 },
      { label: "", amount: 50000, weight: 0.05 },
    ],
  },
}
