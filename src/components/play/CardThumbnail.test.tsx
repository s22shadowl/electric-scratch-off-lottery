...
describe("CardThumbnail", () => {
  it("應渲染卡片元素", () => {
    render(
      <CardThumbnail card={makeCard()} isSelected={false} onToggle={vi.fn()} />,
    );
  ...
  it("已選取時 aria-pressed 應為 true", () => {
    render(
      <CardThumbnail card={makeCard()} isSelected={true} onToggle={vi.fn()} />,
    );
